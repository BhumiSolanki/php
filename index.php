<?php
	...
	if(isset($_POST['txtrno']))
	{
			$rno = $_POST['txtrno'];
			$nm = $_POST['txtnm'];
			$sql = "INSERT INTO `studtable`(`Roll_no`, `Student_name`) VALUES ('$rno','$nm')";
		...
		<div class="container-fluid mt-2">
			...
			<table class="table table-bordered text-center">
				...
				<tr>
					...
					<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-bs-roll="<?php echo $row['Roll_no']; ?>" data-bs-nm="<?php echo $row['Student_name']; ?>" data-bs-id="<?php echo $row['id']; ?>">Update</button>
				<?php
					$i++;
					}
				?>
...
<?php
	if(isset($_POST['txtid']))
	{
		...
		$rno = $_POST['txtnroll'];
		$nm = $_POST['txtnname'];
		$sql = "UPDATE `studtable` SET `Roll_no`='$rno',`Student_name`='$nm' WHERE `id`='$id'";
		mysqli_query($con,$sql);
